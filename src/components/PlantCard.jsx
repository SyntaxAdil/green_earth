  ...
  return (
    <div className="card bg-base-100  shadow-sm aspect-square  p-3 mx-auto w-full transition-all duration-200 border border-white hover:border-[#479f68] group">
      ...
      <div className="py-4 px-2">
        ...
        <Link to={`/plant/${plant.id}`} className="cursor-pointer tooltip" data-tip="Plant Detailes"><Info size={16} /></Link>
        </div>
        ...
        <div className="card-actions justify-end mt-4">
          <button
            className="btn bg-[#15803d] hover:bg-[#0a9a3f] text-white rounded-full w-full"
